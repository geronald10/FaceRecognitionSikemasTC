...
public class AddSetWajahPreviewActivity extends Activity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (front_camera){
            mAddSetWajahView.setCameraIndex(1);
        } else {
            mAddSetWajahView.setCameraIndex(-1);
        }
                    ...
                    if((faces != null) && (faces.length == 1)){
                        ...
                        if(((method == MANUALLY) && capturePressed) || (method == TIME)){
                            ...
                            if(total >= numberOfPictures){
                                Intent intent = new Intent(getApplicationContext(), AddSetWajahActivity.class);
